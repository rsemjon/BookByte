    ...
    <a href="{{ route('show.product', ['id' => $product->id]) }}" class="text-decoration-none text-dark">
        <div class="card border-0 shadow-sm" style="width: 255px;">
            <div class="card-body p-3 text-center">
                <img src="{{ $product->image }}" class="img-fluid rounded mx-auto d-block mb-2"
                    style="max-width: 225px;" alt="{{ $product->title }}">
                <h6 class="text-start text-primary fw-bold mb-1 text-truncate"
                    style="max-width: 220px;">{{ $product->title }}</h6>
