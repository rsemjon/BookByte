            ...
            <form id="productForm" class="w-100" action="{{ route('update.product', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 position-relative">
                    ...
                    <select
                        ...
                        <option value="Papercover" {{ old('cover_type', $product->cover_type) == 'Papercover' ? 'selected' : '' }}>Papercover</option>
                        <option value="Leather" {{ old('cover_type', $product->cover_type) == 'Leather' ? 'selected' : '' }}>Leather</option>
                        <option value="Hardcover" {{ old('cover_type', $product->cover_type) == 'Hardcover' ? 'selected' : '' }}>Hardcover</option>
                    </select>
